...
> Dark, reduced-glare presentation with system fallback.
...
[![PHP](https://img.shields.io/badge/PHP-8.5-777BB4?logo=php&logoColor=white)](https://www.php.net/) [![Latest release](https://img.shields.io/github/v/release/liberusoftware/theme-dark?sort=semver)](https://github.com/liberusoftware/theme-dark/releases/latest) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE.md)

## Visual scope

Dark, reduced-glare presentation with system fallback. It is a presentation-only package: domain behaviour stays in modules and the host application retains control of theme selection and fallback.
...
Focused issues and tested pull requests are welcome in the [GitHub repository](https://github.com/liberusoftware/theme-dark). Keep visual changes accessible, document asset provenance, and update `CHANGELOG.md`.

## Contributors

Thank you to everyone who helps improve Liberu. [View the contributors graph](https://github.com/liberusoftware/theme-dark/graphs/contributors).
