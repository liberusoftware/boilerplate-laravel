...
The trusted `liberu/composer-installer` places the package in `/themes/default`. Composer and its lock file remain the source of version truth, and the installed theme directory is committed by the host.
