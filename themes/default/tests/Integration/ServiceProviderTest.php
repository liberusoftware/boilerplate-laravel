...
namespace Liberu\Themes\DefaultTheme\Tests\Integration;
...
final class ServiceProviderTest extends TestCase
{
    public function test_declared_service_provider_registers_with_the_application(): void
    {
        ...
        $manifest = json_decode((string) file_get_contents($packagePath.'/theme.json'), true, flags: JSON_THROW_ON_ERROR);
